describe('Debe ir a catalogo', () => {
  ...
  it('deberia aparecer la cantidad de producto en carrito al ingresar cantidad al input y disminuir al apretar el boton, si es 0 deberia desaparecer el contenedor', () => {
    cy.get('.ProductCard:nth-child(2) .containerInfoProduct div #quantity').type('3', { force: true })

    cy.get('.ProductCard:nth-child(2) .containerInfoProduct div #quantity').should('be.visible', '3')
    ...
    cy.get('.ProductCard:nth-child(2) .containerInfoProduct div #quantity').should('be.visible', '0')
  })
