...
describe('Pàgina carrito cuando tiene productos ', () => {
  ...
  // it('se agrega dos veces el mismo producto debe aparecer en el carrito', () => { FIXME: falla
  //   cy.get(
  ...
  // })
  // it('se agrega dos productos distintos, deben aparecer por separado en carrito', () => { FIXME: falla
  //   cy.get(
  //     ':nth-child(1) > .generalInfoProduct > .ProductCardInfo > :nth-child(5) > div.jsx-69787f2591a0f36 > :nth-child(3)'
  //   ).click({ force: true })
  //   cy.get(
